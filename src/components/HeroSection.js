...
export default function HeroSection () {
    return (
        ...
        <div>
            <a href="#section1" className="link-underline link-underline-opacity-0 link-opacity-100-hover"><i className="bi bi-currency-bitcoin border border-primary rounded-circle bg-primary text-white me-2"></i>Start your portfolio<i className="ms-2" ></i><ArrowRight/></a>
            <div className="mt-3">
